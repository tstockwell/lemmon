...
public abstract class BundleRevision
{
    ...
    private FileObject m_revisionRootDir = null;
    ...
    **/
    public BundleRevision(Logger logger, FileObject revisionRootDir, String location)
        throws Exception
    {
        m_logger = logger;
    ...
    **/
    public FileObject getRevisionRootDir()
    {
