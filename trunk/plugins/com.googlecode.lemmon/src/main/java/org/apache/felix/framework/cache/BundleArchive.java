...
public class BundleArchive
{
    ...
    private long m_id = -1;
    private FileObject m_archiveRootDir = null;
    ...
    **/
    public BundleArchive(Logger logger, FileObject archiveRootDir, long id,
     ...
     * @throws Exception if any error occurs.
    **/
    public BundleArchive(Logger logger, FileObject archiveRootDir)
        throws Exception
    {
        m_logger = logger;
        m_archiveRootDir = archiveRootDir;
        ...
        while (true)
        {
            ...
            FileObject revisionRootDir = m_archiveRootDir.resolveFile( 
                REVISION_DIRECTORY + getRefreshCount() + "." + revisionCount, NameScope.CHILD );
    ...
    public synchronized long getId() throws Exception
    {
        ...
        try
        {
            is = BundleCache.getSecureAction()
                .getFileInputStream(m_archiveRootDir.resolveFile( BUNDLE_ID_FILE, NameScope.CHILD));
        ...
        catch (FileNotFoundException ex)
        {
            ...
            m_id = Long.parseLong(
                m_archiveRootDir.getName().getBaseName().substring(
    ...
    **/
    public synchronized String getLocation() throws Exception
    {
        ...
        {
            is = BundleCache.getSecureAction()
                .getFileInputStream(m_archiveRootDir.resolveFile( BUNDLE_LOCATION_FILE, NameScope.CHILD));
            br = new BufferedReader(new InputStreamReader(is));
    ...
    **/
    public synchronized int getPersistentState() throws Exception
    {
        ...
        FileObject stateFile = m_archiveRootDir.resolveFile( BUNDLE_STATE_FILE, NameScope.CHILD);
    ...
    public synchronized void setPersistentState(int state) throws Exception
    {
        ...
        try
        {
            os = BundleCache.getSecureAction()
                .getFileOutputStream(m_archiveRootDir.resolveFile( BUNDLE_STATE_FILE, NameScope.CHILD));
    ...
    **/
    public synchronized int getStartLevel() throws Exception
    {
        ...
        FileObject levelFile = m_archiveRootDir.resolveFile( BUNDLE_START_LEVEL_FILE, NameScope.CHILD);
    ...
    **/
    public synchronized void setStartLevel(int level) throws Exception
    {
        ...
        {
            os = BundleCache.getSecureAction()
                .getFileOutputStream(m_archiveRootDir.resolveFile( BUNDLE_START_LEVEL_FILE, NameScope.CHILD));
            bw = new BufferedWriter(new OutputStreamWriter(os));
    ...
    **/
    public synchronized long getLastModified() throws Exception
    {
        ...
        FileObject lastModFile = m_archiveRootDir.resolveFile( BUNDLE_LASTMODIFIED_FILE, NameScope.CHILD);
    ...
    **/
    public synchronized void setLastModified(long lastModified) throws Exception
    {
        ...
        {
            os = BundleCache.getSecureAction()
                .getFileOutputStream(m_archiveRootDir.resolveFile( BUNDLE_LASTMODIFIED_FILE, NameScope.CHILD));
            bw = new BufferedWriter(new OutputStreamWriter(os));
    ...
    public synchronized FileObject getDataFile(String fileName) throws Exception
    {
        // According to the OSGi spec we should return null if underlying 
        // platform does not support a file system
        return null; 
    }
    ...
    **/
    ...
    public synchronized boolean rollbackRevise() throws Exception
    {
        ...
        FileObject revisionDir = m_archiveRootDir.resolveFile( REVISION_DIRECTORY +
            getRefreshCount() + "." + (m_revisions.length - 1), NameScope.CHILD);
    ...
    private synchronized String getRevisionLocation(int revision) throws Exception
    {
        ...
        try
        {
            FileObject revDirectory= m_archiveRootDir.resolveFile( REVISION_DIRECTORY + getRefreshCount() + "." + revision, NameScope.CHILD);
            FileObject locDirectory= revDirectory.resolveFile( REVISION_LOCATION_FILE, NameScope.CHILD);
            is = BundleCache.getSecureAction().getFileInputStream(locDirectory);
    ...
    private synchronized void setRevisionLocation(String location, int revision) throws Exception
    {
        ...
        try
        {
            FileObject revDirectory= m_archiveRootDir.resolveFile( REVISION_DIRECTORY + getRefreshCount() + "." + revision, NameScope.CHILD);
            FileObject locDirectory= revDirectory.resolveFile( REVISION_LOCATION_FILE, NameScope.CHILD);
            os = BundleCache.getSecureAction().getFileOutputStream(locDirectory);
            bw = new BufferedWriter(new OutputStreamWriter(os));
    ...
    **/
    public synchronized void purge() throws Exception
    {
        ...
        for (int i = 0; i < count - 1; i++)
        {
            ...
            revisionDir = m_archiveRootDir.resolveFile( REVISION_DIRECTORY + refreshCount + "." + i, NameScope.CHILD);
            if (BundleCache.getSecureAction().fileExists(revisionDir))
            {
                BundleCache.deleteDirectoryTree(revisionDir);
            }
        ...
        FileObject currentDir = m_archiveRootDir.resolveFile( REVISION_DIRECTORY + (refreshCount + 1) + ".0", NameScope.CHILD);
        revisionDir = m_archiveRootDir.resolveFile( REVISION_DIRECTORY + refreshCount + "." + (count - 1), NameScope.CHILD);
    ...
    **/
    private void initialize() throws Exception
    {
        ...
        try
        {
            ...
            // Save id.
            os = BundleCache.getSecureAction()
                .getFileOutputStream(m_archiveRootDir.resolveFile( BUNDLE_ID_FILE, NameScope.CHILD));
            bw = new BufferedWriter(new OutputStreamWriter(os));
            ...
            os = BundleCache.getSecureAction()
                .getFileOutputStream(m_archiveRootDir.resolveFile( BUNDLE_LOCATION_FILE, NameScope.CHILD));
            bw = new BufferedWriter(new OutputStreamWriter(os));
    ...
    **/
        ...
        throws Exception
    {
        ...
        FileObject revisionRootDir = m_archiveRootDir.resolveFile( 
            REVISION_DIRECTORY + getRefreshCount() + "." + getRevisionCount(), NameScope.CHILD);
    ...
    **/
    private long getRefreshCount() throws Exception
    {
        ...
        FileObject counterFile = m_archiveRootDir.resolveFile( REFRESH_COUNTER_FILE, NameScope.CHILD);
